...
import { Header, RoomsWrapper, ChatAligner } from './style';
import { Button, Title, Modal } from '../../atoms';
import { Loader } from '../../molecules';
import { LobbyLayout, Center } from '../../layouts';
import { MainLobbyAPI, socket, GameLobbyAPI, history } from '../../../services';
import { Room, GameStatus, RoomStatus, Auth } from '../../../types/dealiooo';
...
class MainLobby extends Component<Props, State> {
      ...
      <LobbyLayout>
        ...
        <div>
          <Header>
            ...
            <Button secondary disabled={!auth} onClick={auth ? this.openModal : undefined}>
              Create a Room
            </Button>
          </Header>
          <RoomsWrapper>
        ...
        <ChatAligner>
          <Chat channel="main-lobby:chat" onSend={this.handleSendMessage} disabledSend={!auth} />
        </ChatAligner>
      </LobbyLayout>
    );
  }
